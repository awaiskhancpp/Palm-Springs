  ...
  return (
    ...
    >
      <div className="relative max-w-[1441px] mx-auto px-6 lg:px-8 xl:px-0 pt-10 mt-8 lg:pt-0 pb-0">
        ...
        <div className="2xl:hidden block absolute top-17 -right-26 w-8 h-8 md:w-12 md:h-12 bg-gradient-to-b from-[#FFA500] to-[#EA7000] rounded-full" />
        ...
        <div className="2xl:hidden absolute -left-30 top-2 w-24 h-24 md:w-[100px] md:h-[100px] rounded-full bg-gradient-to-b from-[#FFA500] to-[#EA7000]" />

        <div className="grid grid-cols-1 lg:grid-cols-2 items-center p-10 lg:p-0">
          {/* Left Content */}
          <div className="order-2 lg:order-1 flex flex-col gap-4">
            {/* Welcome Badge */}
            <div className="inline-flex items-center  mt-2  border border-[#232323] rounded-full px-4 md:px-8 py-2  w-fit">
              <span className="font-avenir-lt font-extralight text-[13px] md:text-[22px] text-[#232323]">
                Welcome to 1REALTOUR.com
              </span>
            </div>

            {/* Main Heading */}
            <h1 className="font-futura-black text-[36px] font-bold sm:text-[48px] xl:text-[56px] leading-[1.2]">
            ...
            {/* Subheading */}
            <p className="font-avenir-lt font-extralight text-[18px] text-[#333333] tracking-[0%] leading-7 max-w-[630px]">
